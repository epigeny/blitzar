...
import { isArray, isString, isBoolean, isFunction, isFullString, isPlainObject, isNullOrUndefined, isUndefined, isFullArray, isNumber } from "is-what";
      ...
      return openBlock(), createElementBlock("div", {
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.cSchema, (subfield, fieldIndex) => {
          return openBlock(), createBlock(_component_BlitzField, mergeProps({ key: fieldIndex }, subfield, {
            ...
            rowInput: (params) => _ctx.setSubFieldValue({ id: params.id, value: params.value, rowIndex }),
          ...
          }), null, 16, ["rowIndex", "rowData", "rowInput", "deleteRow", "modelValue", "onUpdate:modelValue", "onKeyup"]);
        }), 128))
      ], 4);
    }), 128))
  ], 6);
